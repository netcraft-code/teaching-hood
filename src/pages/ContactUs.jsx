  ...
  return (
    <>
      ...
      <section className="relative w-full bg-transparent overflow-visible h-[300px] sm:h-[350px] md:h-[400px] lg:h-[440px]">
        ...
        <div className="relative -mt-16 sm:-mt-20 md:-mt-24 lg:-mt-28 bg-transparent">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-2 gap-8 mx-56">
                    {stats.map((stat, index) => {
                        return (
                            <div
                                key={index}
                                className="bg-white rounded-2xl p-2 sm:p-4 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
                            >
                                <div className={`${stat.bgColor} w-6 h-6 sm:w-8 sm:h-8 rounded-xl flex items-center justify-center mb-2 sm:mb-3`}>
                                    {stat.icon}
                                </div>
                                <div className="text-xl font-regular text-gray-900 my-3 justify-center">
                                    {stat.value}
                                </div>
                                <div className="text-xs sm:text-sm text-blue-500 font-medium justify-center">
                                    {stat.label}
                                </div>
                                <div className="text-sm font-regular text-gray-900 my-4 sm:my-4 justify-center">
                                    {stat.text}
                                </div>
                            </div>
                        );
      ...
      <div className="max-w-6xl grid grid-cols-2 lg:grid-cols-3 gap-4 mt-36 mx-20">
          ...
          <div className="space-y-6">
            {/* Quick Response Box */}
            <div className="flex rounded-2xl p-6 shadow-md bg-blue-50">
              <div>
                {/* Icon + Heading */}
            ...
            <div className="flex rounded-2xl p-6 shadow-md w-full">
              <div className='w-full'>
                ...
                <button className='text-yellow-500 bg-[#FEFCE8] hover:bg-red-100 w-full p-2'>
                    View All FAQs
                </button>
              </div>
            </div>
      ...
      <div className="my-28">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mx-28">
            <div className="shadow-lg p-8 rounded-xl">
                ...
                <p className="text-gray-500 text-xs leading-6 flex items-center">
