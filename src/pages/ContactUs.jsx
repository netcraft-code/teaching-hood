        ...
        >
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-16 md:pt-20">
            ...
            <div className="text-center mb-8 sm:mb-12 md:mb-16">
              ...
              <h2 className="text-2xl sm:text-base md:text-lg font-semibold tracking-tight px-4">
            ...
            <div className="grid grid-cols-2 gap-4 sm:gap-6 md:gap-8 mx-4 sm:mx-8 md:mx-20 lg:mx-56">
              {stats.map((stat, index) => {
                return (
                  ...
                  >
                    <div
                      className={`${stat.bgColor} w-8 h-8 rounded-xl flex items-center justify-center mb-3`}
                    >
                      {stat.icon}
                    </div>
            ...
            <div className="w-full">
              ...
              <div className="flex justify-evenly items-center w-full mt-4">
                {[
                  ...
                  {
                    Icon: contactUsIcons.linkedIn,
                    url: "https://www.linkedin.com/company/teachinghood",
                  },
                  {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 mx-4 sm:mx-8 md:mx-16 lg:mx-28">
          <div className="shadow-lg p-6 sm:p-8 rounded-xl">
            <span className="font-semibold text-base mb-2 flex items-center">
              <span className="text-blue-500 mr-3"> Q. </span> What are your
              support hours?
            </span>
            <p className="text-gray-500 text-base leading-6 flex items-center mt-2">
              ...
              IST. We typically respond to all queries within 24 hours during
              business days.
            </p>
          </div>
          ...
          <div className="shadow-lg p-6 sm:p-8 rounded-xl">
            <span className="font-semibold text-base mb-2 flex items-center">
              <span className="text-blue-500 mr-3"> Q. </span> How quickly will
          ...
          <div className="shadow-lg p-6 sm:p-8 rounded-xl">
            <span className="font-semibold text-base mb-2 flex items-center">
              <span className="text-blue-500 mr-3"> Q. </span> Do you offer
              phone support?
            </span>

            <p className="text-gray-500 text-base leading-6 flex items-center mt-2">
              Yes! You can reach us at +91-9928038204 during business hours for
          ...
          <div className="shadow-lg p-6 sm:p-8 rounded-xl">
            <span className="font-semibold text-base mb-2 flex items-center">
              <span className="text-blue-500 mr-3"> Q. </span> Can I schedule a
              demo or consultation?
            </span>

            <p className="text-gray-500 text-base leading-6 flex items-center mt-2">
              Absolutely! Please fill out the contact form selecting "Schedule a
              Demo" and our team will reach out to arrange a convenient time.
            </p>
          </div>
        </div>
      </div>
