    ...
    <section className="py-16 md:py-24 mx-5">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div>
            {/* Badge */}
            <div className="inline-flex items-center space-x-2 bg-red-50 px-4 rounded-full mb-6 py-2">
              <span className="text-lg text-red-600 font-semibold text-[22px]">
                For Teachers
              </span>
            </div>
            <a
              href="/signup"
              className="relative top-[7px] h-[25px] inline-flex items-center space-x-2 px-4 rounded-full mb-6 ml-4 font-bold bg-blue-500 text-white py-1"
            >
              Create Profile
            </a>
