...
const TeachersSection = () => {
  const features = [
    {
      icon: <img src={homePageIcons.teacherSimplyApply} className="w-5 h-5 text-blue-600 bg-blue-50" alt="Join Free Icon" />,
      text: 'Simply apply filters by your subject, grade, and location & hit apply.',
      bgColor: 'bg-blue-50'
    },
    {
      icon: <img src={homePageIcons.teacherStayLoop} className="w-5 h-5 text-yellow-500 bg-yellow-50" alt="Simply Apply Icon" />,
      text: 'Stay in the loop with interview feedback and application updates. We bridge the gap so you\'re never left waiting.',
      bgColor: 'bg-red-50'
    },
    {
      icon: <img src={homePageIcons.teacherJoinFree} className="w-5 h-5 text-green-500 bg-green-50" alt="Stay in Loop Icon" />,
  ...
  return (
    <section className="py-16 md:py-24 mx-16">
