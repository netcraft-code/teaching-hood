...
const TiredOfPostingSection = () => {
    ...
    //             <div className="text-center mb-12">
    //                 <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 leading-tight">
    //                     Tired of posting jobs on Facebook <br />
    ...
    //                             value={location}
    //                             onChange={(e) => setLocation(e.target.value)}
    //                             className="w-full pl-10 pr-4 py-4 border border-gray-200 rounded-lg font-sf text-[14px] font-normal leading-[100%] tracking-[0] text-[#717182] bg-[#F5F6F7] focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none"
    //                         >
    //                             <option value="" disabled>Location (e.g., Delhi)</option>
    ...
    //                         {/* dropdown arrow */}
    //                         <span className="absolute right-4 top-1/2 -translate-y-1/2 text-[#717182] pointer-events-none">
    //                             ▼
    //                         </span>
    //                     </div>

    //                     {/* Search Button */}
    //                     <button onClick={handleSearch} className="bg-blue-500 text-white px-8 py-4 rounded-lg hover:bg-blue-700 transition font-sf font-bold text-[16px] leading-[24px] tracking-[0] text-center align-middle whitespace-nowrap">
    //                         Search Profiles
    //                     </button>
    //                 </div>
    //             </div>
