...
const RecruitersSection = () => {
  const features = [
    {
      icon: <img src={homePageIcons.recruiterNowPromote} className="w-6 h-6 text-green-500" alt="Promote Icon" />,
      text: 'Now promote vacancies for your partner schools and reach relevant candidates more effectively.',
      bgColor: 'bg-green-50'
    },
    {
      icon: <img src={homePageIcons.recruiterUnderstood} className="w-6 h-6 text-blue-500" alt="Understood Icon" />,
      text: 'Teachinghood understands what teachers want and what schools need.',
      bgColor: 'bg-blue-50'
    },
    {
      icon: <img src={homePageIcons.recruiterBuildTrust} className="w-6 h-6 text-red-500" alt="Build Trust Icon" />,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div>
            ...
            <div className="inline-flex items-center space-x-2 bg-yellow-50 px-4 py-2 rounded-full mb-6">
              <span className="text-lg text-yellow-400 font-semibold text-[21.39px]">For Recruiters</span>
            </div>
            ...
            <div className="bg-[linear-gradient(135deg,#FEFCE8_0%,#F0FDF4_100%)] border-2 border-yellow-100 rounded-2xl p-6">
              <h3 className="text-xl font-normal text-gray-900 mb-3">Become a Partner</h3>
