  ...
  const features = [
    {
      icon: (
        <img
          src={homePageIcons.schoolPostUnlimited}
    ...
    },
    {
      icon: (
        <img
          src={homePageIcons.schoolGetFree}
    ...
    },
    {
      icon: (
        <img
          src={homePageIcons.schoolFindRight}
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="mx-8">
            ...
            <a
              href="/signup"
              className="inline-flex items-center space-x-2 bg-red-50 px-4 py-2 rounded-full mb-6 ml-4 font-bold text-green-600"
            >
              Post a Job
            </a>
