        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-6 text-center">
              ...
              <div>
                <div className="font-sf font-normal text-[30px] leading-[36px] text-green-600 mb-2">200+</div>
                <div className="font-sf font-normal text-[14px] leading-[20px] text-gray-900">Partner Schools</div>
              </div>
              <div>
                <div className="font-sf font-normal text-[30px] leading-[36px] text-blue-600 mb-2">500+</div>
                <div className="font-sf font-normal text-[14px] leading-[20px] text-gray-900">Active Teachers</div>
              </div>
            </div>
          </div>
                ...
                <div className="relative w-full lg:w-[95%]">
                  ...
                  <div className="absolute bottom-1 -left-2 md:-left-6 transform -translate-y-1/2 -translate-x-1/4 bg-white rounded-xl shadow-lg p-4 flex items-center space-x-3 z-10">
                    ...
                    <div className="flex flex-col">
                      <span className="text-xs md:text-sm font-medium text-gray-600">Community</span>
                      <span className="font-normal text-sm md:text-lg text-gray-900">Growing Daily</span>
                    </div>
                  </div>
                </div>
            </div>
