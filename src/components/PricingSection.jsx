      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-600 via-indigo-600 to-purple-700 py-12 md:py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-center gap-4 mb-12">
            ...
            <span
              className={`text-sm sm:text-base font-semibold transition-all flex items-center gap-2 ${
            ...
            {plans.map((plan) => (
              <div
                ...
                className={`relative bg-white rounded-2xl shadow-xl transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 ${
                  plan.highlighted
                    ? "md:scale-105 border-4 border-blue-500"
                    : ""
                }`}
              >
                {plan.recommended && (
                ...
                <div className="p-6 sm:p-8">
                  ...
                  <div className="text-center mb-6">
                    <div
                      className={`w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-4 rounded-2xl bg-gradient-to-br ${plan.gradient} flex items-center justify-center text-3xl sm:text-4xl`}
                    >
                      {plan.icon}
                    </div>
